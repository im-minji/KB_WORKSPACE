<template>
  ...
  <!-- TODO 2. composition api로 data옵션과 computed로 구성합니다-->
...
export default {
  ...
  setup() {
    ...
    const calcToUsD = (e) => {
      usd1.value = Math.round((e.target.value / rate1) * 100000) / 100000;
    };
    ...
    return { rate1, usd1, krw1, calcToKrW, calcToUsD, rate2, usd2, krw2 };
  },
};
</script>
