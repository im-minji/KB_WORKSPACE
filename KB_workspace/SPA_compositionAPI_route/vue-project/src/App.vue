  ...
  <header class="container-fluid sticky-top">
    ...
    >
      <a class="navbar-brand d-flex align-items-center" href="#">
        <!-- <img src="./assets/images/logo-75.png" alt="로고" height="75" /> -->
        <img v-bind:src="logo" alt="로고" />
      </a>
      ...
      >
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            > -->
            <!-- to="./product" 처럼 path사용하지말자-->
            <router-link to="/product">
              <i class="fa-solid fa-mug-saucer"></i>상품
            </router-link>
          </li>
          <li class="nav-item">
            <a class="nav-link px-3 text-nowrap" href="#"
...
import logo from '@/assets/images/logo-75.png'; //npm run build (빌드할 때 일어나는 일) : 이미지 파일을 감지함 -> /dist/assets/logo-xxxx.png 형태로 복사 ->파일명에 해시 추가 (캐시 방지) -> JS 안의 logo 값을 자동으로 실제 경로로 바꿔줌
export default {
  name: 'App',
  ...
  data() {
    return {
      logo: logo,
      // logo: './assets/images/logo-75.png', //이 문자열을 “파일 경로”라고 인식 못함
      //<img src="./assets/images/logo-75.png" alt="로고" height="75" />이거나
      //logo: './assets/images/logo-75.png'라고 해도 되는데???
      // 빌드 시 경로 깨질 가능성 있음
      // Webpack/Vite가 파일 추적 못함
    };
  },
};
</script>
