  ...
  <header class="container-fluid sticky-top">
    ...
    >
      <a class="navbar-brand d-flex align-items-center" href="#">
        ...
        <img :src="logo" alt="로고" height=" :63" ; />
        <!-- 경로를 ./~~/~~ 로 문자열로 넣게 되면 파일 경로라고 인식하지 못함 
         logo: './~/~~/~~~/... 라고 해서 npm run dev로 실행은 될 수 있으나 
         빌드시 경로 깨질 가능성이 매우 높고 Webpack/vite가 파일 추적 하지 못함' -->
      </a>
...
그룹화: 로고를 제외한 모든 메뉴 항목(로그인, 가입 등)을 하나의 덩어리로 묶어, 모바일에서 한꺼번에 토글(Toggle)되도록 합니다-->
  ...
  <main class="main-container">
    <section class="main-container__content overflow-auto">
      ...
      <h2>본문 내용</h2>
      <!-- <div style="height: 500px">아주 큰내용</div> -->
      <Product></Product>
