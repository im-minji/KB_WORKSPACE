...
app.get("/product/:prodNo", (req, res) => {
  ...
  if (req.params.prodNo == "C0001") {
    responseObj = { prodNo: "C0001", prodName: "아메리카노", img: "C0001.jpg" };
    ...
    responseObj = { prodNo: "C0003", prodName: "라테", img: "C0003.jpg" };
  } else if (req.params.prodNo == "C0004") {
    responseObj = { prodNo: "C0004", prodName: "아이스라테", img: "C0004.jpg" };
    ...
    responseObj = { prodNo: "C0006", prodName: "카페브레베", img: "C0006.jpg" };
  } else if (req.params.prodNo == "C0007") {
    responseObj = { prodNo: "C0007", prodName: "바닐라라떼", img: "C0007.jpg" };
  } else {
    responseObj = {};
  }
  res.json(responseObj);
